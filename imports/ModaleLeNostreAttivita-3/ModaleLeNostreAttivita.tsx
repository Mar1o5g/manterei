function Heading() {
  return (
    <div className="content-stretch flex items-center justify-center relative shrink-0" data-name="Heading 2">
      <p className="font-['Amatic_SC:Bold',sans-serif] leading-[40px] not-italic relative shrink-0 text-[#0e4542] text-[48px] tracking-[0.9px] whitespace-nowrap">Viaggi di istruzione</p>
    </div>
  );
}
